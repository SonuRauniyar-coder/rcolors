        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              R Colors Infratech specializes in property sales, plot development, and real estate partnerships. We connect buyers, investors, and developers through transparent and reliable property solutions.
            </p>
            <p className="text-gray-600 leading-relaxed text-lg">
